...
def expand_prompts(
    ...
    Args:
        ...
        num_random_samples: Number of random samples to generate when combinatorial=False
    ...
    if not combinatorial and num_random_samples > max_samples:
        raise ValueError(f"num_random_samples ({num_random_samples}) cannot exceed max_samples ({max_samples})")
