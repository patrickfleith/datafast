...
class DatasetBase(ABC):
    ...
    def push_to_hub(
        ...
        Args:
            ...
            train_size: If provided, fraction of data to use for training (e.g., 0.8 for 80% train)
        ...
        try:
            ...
            if "did not recognize Python value type" in str(e):
                raise ValueError(f"Data type conversion error. Please ensure all fields are of supported types. Original error: {str(e)}")
            raise
