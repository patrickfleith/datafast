...
from datafast import Source, Sink
...
pipeline_a = (
    ...
    >> Sink.jsonl("examples/outputs/05_from_list.jsonl")
)
pipeline_a.run()

# --- Part B: Source.jsonl → Sink.parquet (round-trip) ---
pipeline_b = (
    Source.jsonl("examples/outputs/05_from_list.jsonl")
    >> Sink.parquet("examples/outputs/05_round_trip.parquet")
)
pipeline_b.run()
