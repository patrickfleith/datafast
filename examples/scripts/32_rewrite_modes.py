...
from datafast import Source, Rewrite, Sink, openrouter
...
pipeline_simplify = (
    ...
    >> Sink.jsonl("examples/outputs/32_rewrite_simplify.jsonl")
)
...
pipeline_formalize = (
    ...
    >> Sink.jsonl("examples/outputs/32_rewrite_formalize.jsonl")
)
...
pipeline_custom = (
    ...
    >> Sink.jsonl("examples/outputs/32_rewrite_custom.jsonl")
)
pipeline_custom.run()
...
pipeline_audience = (
    ...
    >> Sink.jsonl("examples/outputs/32_rewrite_audience.jsonl")
)
...
pipeline_elaborate = (
    ...
    >> Sink.jsonl("examples/outputs/32_rewrite_elaborate.jsonl")
)
