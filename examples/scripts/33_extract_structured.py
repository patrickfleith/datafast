...
from datafast import Source, Extract, Sink, openrouter
import litellm
...
pipeline_custom = (
    ...
    >> Sink.jsonl("examples/outputs/33_extract_custom.jsonl")
)
pipeline_custom.run()
...
pipeline_entities = (
    ...
    >> Sink.jsonl("examples/outputs/33_extract_entities.jsonl")
)
