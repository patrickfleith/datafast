"""Gemini example comparing normalized fields with raw payload fields."""
...
def main() -> None:
    ...
    # Reasoning is requested so the normalized vs raw reasoning fields populate.
    model = gemini(MODEL_ID, temperature=0, reasoning_effort="high")
    ...
    raw_reasoning = _get_attr_or_key(message, "reasoning_content")
    ...
    print(f"raw reasoning_content: {bool(raw_reasoning)}")
